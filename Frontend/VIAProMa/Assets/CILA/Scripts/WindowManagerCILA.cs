...
{
    public class WindowManagerCILA : Singleton<WindowManagerCILA>
    {
        ...
        private void Start()
        {
            ...
            LoginMenu = (LoginMenuCILA)InstantiateWindow(loginMenuPrefab);
        }
        ...
        public LoginMenuCILA LoginMenu { get; private set; }
    }
}