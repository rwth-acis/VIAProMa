...
namespace i5.VIAProMa.UI.MainMenuCube
{
    ...
    public class MainMenuCILA : MonoBehaviourPunCallbacks
    {
        [Header("UI Elements")]
        ...
        {
            WindowManagerCILA.Instance.SaveProjectWindow.Open(saveButton.transform.position + 0.4f * transform.right, transform.localEulerAngles);
        ...
        {
            WindowManagerCILA.Instance.LoginMenu.Open(loginButton.transform.position, loginButton.transform.eulerAngles);
        }
        ...
        {
            WindowManagerCILA.Instance.ServerStatusMenu.Open(serverConnectionButton.transform.position - 0.4f * transform.right, transform.localEulerAngles);
            foldController.FoldCube();
        }
        ...
        public void RoomButtonClicked()
        {
            ...
            if (PhotonNetwork.InLobby)
            {
                WindowManagerCILA.Instance.RoomMenu.Open(roomButton.transform.position - 0.6f * transform.right, transform.localEulerAngles);
            }
            else
            {
        ...
        {
            WindowManagerCILA.Instance.ChatMenu.Open(chatButton.transform.position - 0.6f * transform.right, transform.localEulerAngles);
            foldController.FoldCube();
        }
