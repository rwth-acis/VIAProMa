...
[RequireComponent(typeof(ProgressVisualizer))]
public class ProgressSynchronizer : TransformSynchronizer
{
    private ProgressVisualizer visualizer;
    private int remoteSynchronization = 0;
    private bool initialized;

    private void Awake()
    {
        visualizer = GetComponent<ProgressVisualizer>();
    }
