...
struct SimpleCurveGenerationJob : IJobParallelFor
{
    ...
    public void InitialiseArrays(int length)
    {
        ...
        curvePoint3 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint4 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint5 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint6 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint7 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint8 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint9 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint10 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint11 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint12 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint13 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint14 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint15 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint16 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint17 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint18 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint19 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint20 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint21 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint22 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint23 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint24 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint25 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint26 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint27 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint28 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint29 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint30 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint31 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint32 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint33 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint34 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint35 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint36 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint37 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint38 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint39 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint40 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint41 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint42 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint43 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint44 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint45 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint46 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint47 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint48 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint49 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint50 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint51 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint52 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint53 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint54 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint55 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint56 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint57 = new NativeArray<Vector3>(length, Allocator.Persistent);
        curvePoint58 = new NativeArray<Vector3>(length, Allocator.Persistent);
