...
namespace i5.VIAProMa.UI.DropdownMenu.Core
{
    public class ExportSelectiobDropdownMenu<DataType, ItemType> : MonoBehaviour
    ...
    public class ExportSelectionDropdownMenu : DropdownMenu<ListViewItemInspectorData, ListViewItem>
    {
    }
}