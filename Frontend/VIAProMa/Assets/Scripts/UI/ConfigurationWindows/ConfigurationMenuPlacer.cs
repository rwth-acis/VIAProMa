...
namespace i5.VIAProMa.UI.AppBar
{
    ...
    /// </summary>
    public class ConfigurationMenuPlacer : MonoBehaviour
    {
        ...
        private void FollowBoundingBox(bool smooth)
        {
            ...
            boundsPoints.Clear();
            helper.GetRawBoundsCorners(boundsControl.BoundsOverride);
            helper.UpdateNonAABoundsCornerPositions(boundsControl.BoundsOverride, boundsPoints);
            ...
            Vector3 direction = (boundsControl.BoundsOverride.bounds.center - finalPosition).normalized;
