...
namespace i5.VIAProMa.UI
{
    public class WindowManager : Singleton<WindowManager>
    {
        ...
        [SerializeField] private GameObject pollMenuPrefab;
        ...
        private void Start()
        {
            ...
            PollMenu = (PollMenu)InstantiateWindow(pollMenuPrefab);
        }
        ...
        public PollMenu PollMenu { get; private set; }
    }
}