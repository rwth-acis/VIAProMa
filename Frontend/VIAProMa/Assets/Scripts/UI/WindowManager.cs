...
namespace i5.VIAProMa.UI
{
    public class WindowManager : Singleton<WindowManager>
    {
        ...
        [SerializeField] private GameObject visualCustomizationPrefab;
        ...
        private void Start()
        {
            ...
            VisualCustomizationMenu = (VisualCustomizationMenu)InstantiateWindow(visualCustomizationPrefab);
        }
